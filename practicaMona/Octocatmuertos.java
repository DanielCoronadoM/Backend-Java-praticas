...
public class Octocatmuertos extends Mona {
    ...
    public Octocatmuertos(String nombre, String especie, int extremidades, String vestimenta, String color, String accesorio1, String accesorio2, String accesorio3, String accesorio4, String actividad) {
    ...
    public String mostrarMona() {
        return "Nombre: "+nombre+
                ...
                "\nAccesorio 3: "+accesorio3+
                "\nAccesorio 4: "+accesorio4+
